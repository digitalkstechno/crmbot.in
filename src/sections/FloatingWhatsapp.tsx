...
export const FloatingWhatsApp = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
        ...
        {showTooltip && (
          ...
          >
            ...
            <p className="text-[11px] text-gray-500 leading-relaxed">
              Questions about CRMbot? Chat with us on WhatsApp!
            </p>
            {/* Arrow */}
      ...
      {/* Button */}
      <motion.a
        href="https://wa.me/918866779008?text=Hi!%20I%20want%20to%20know%20more%20about%20CRMbot."
        target="_blank"
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-14 h-14 bg-[#00bc7d] hover:bg-green-400 rounded-full flex items-center justify-center shadow-2xl shadow-green-300/50 transition-colors"
      >
        {/* Pulse ring */}
