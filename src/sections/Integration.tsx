...
const Integration = () => {
  ...
  return (
    <section className=" py-20 px-6 sm:px-10 md:px-12 lg:px-15 overflow-hidden">
      <div className="max-w-7xl mx-auto text-center">
        ...
        {/* 2 lines ma set karva mate width optimize kari */}
        <div className="flex flex-wrap justify-center gap-x-4 gap-y-5 max-w-[1100px] mx-auto">
