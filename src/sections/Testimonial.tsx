...
const Testimonial = () => {
  ...
  return (
    <section className="bg-[#f9fafb] py-20 px-6 sm:px-10 md:px-12 lg:px-15  font-jakarta" id='testimonials'>
          ...
          >
            {testimonials.map((item, index) => (
              <SwiperSlide key={index} className="!h-auto">
                <div className="bg-white border border-gray-100 p-8 rounded-[24px] shadow-sm h-full flex flex-col justify-between ">
                  <div>
                    {/* Stars */}
